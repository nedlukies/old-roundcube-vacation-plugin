...
//            $str = "To use aliases, add more identities.";
    ...
    final public function save()
    {
        ...
        $this->subject = rcube_utils::get_input_value('_vacation_subject', rcube_utils::INPUT_POST, true);
        ...
        $this->body = rcube_utils::get_input_value('_vacation_body', rcube_utils::INPUT_POST, true);
